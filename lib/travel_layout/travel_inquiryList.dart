...
class TravelInquirylist extends StatefulWidget {
  const TravelInquirylist({super.key});

  @override
  State<TravelInquirylist> createState() => _TravelInquirylistState();
}

class _TravelInquirylistState extends State<TravelInquirylist> {
  var travelID = "";
  var message = "";
  var hotelID = "";
  ...
  Future<void> selectInquiry() async {
    ...
    try {
      var res = await http.post(Uri.parse(TravelApi.inquirySelect), body: {
        'agency_id': travelID,
      });
      print(travelID);
